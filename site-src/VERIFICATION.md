...
- `python algorithm-interview-notes/site-src/verify.py`：16 个 HTML 页面、63 个小节、598 处本地引用通过检查；116 份 C++ 下载（含第一章新增 7 份、第二章新增 16 份、第三章新增 16 份、第四章新增 14 份）与讲义内容一致，前四章合计 129 个问答的答案完整显示。
