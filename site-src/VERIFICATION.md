...
- `python algorithm-interview-notes/site-src/verify.py`：16 个 HTML 页面、63 个小节、578 处本地引用通过检查；102 份 C++ 下载（含第一章新增 7 份、第二章新增 16 份、第三章新增 16 份）与讲义内容一致，前三章合计 97 个问答的答案完整显示。
